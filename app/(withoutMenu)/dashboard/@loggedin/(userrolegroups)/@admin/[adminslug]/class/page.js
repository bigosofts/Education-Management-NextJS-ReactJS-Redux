...
import NewClassForm from "@/components/classform/newclassform";
import UpdateClassForm from "@/components/classform/updateclassform";
    ...
    <div className="main-box w-full min-w-[250px] overflow-y-scroll mx-5 pb-10">
      ...
      {flag ? (
        <div className="container mx-auto">
          {visible ? (
            <NewClassForm statechanger={cardstateupdateHandler} />
          ) : (
            <></>
          )}
        </div>
