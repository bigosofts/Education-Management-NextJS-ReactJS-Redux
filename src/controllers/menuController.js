...
exports.createMenu = (req, res) => {
    ...
    menuModel.create(postBody).then((data)=>{
        res.status(200).json({
...
exports.selectMenus=(req,res)=>{
    ...
    menuModel.find(query, projection).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
...
exports.updateMenu=(req,res)=>{
    ...
    menuModel.updateOne({_id:filter}, {$set:postBody},{upsert:true}).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
...
exports.deleteMenu=(req,res)=>{
    ...
    menuModel.deleteOne({_id:_id}).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
