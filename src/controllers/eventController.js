...
exports.createEvent = (req, res) => {
    ...
    eventModel.create(postBody).then((data)=>{
        res.status(200).json({
...
exports.selectEvents=(req,res)=>{
    ...
    eventModel.find(query, projection).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
...
exports.updateEvent=(req,res)=>{
    ...
    eventModel.updateOne({_id:filter}, {$set:postBody},{upsert:true}).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
...
exports.deleteEvent=(req,res)=>{
    ...
    eventModel.deleteOne({_id:_id}).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
