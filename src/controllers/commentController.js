...
exports.createComment = (req, res) => {
    ...
    commentModel.create(postBody).then((data)=>{
        res.status(200).json({
...
exports.selectComments=(req,res)=>{
    ...
    commentModel.find(query, projection).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
...
exports.updateComment=(req,res)=>{
    ...
    commentModel.updateOne({_id:filter}, {$set:postBody},{upsert:true}).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
...
exports.deleteComment=(req,res)=>{
    ...
    commentModel.deleteOne({_id:_id}).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
