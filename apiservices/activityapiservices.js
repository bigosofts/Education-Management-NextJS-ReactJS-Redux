...
exports.deleteData = async (id) => {
  const res = await fetch(`${process.env.URL}/apis/v1/delete-activity/${id}`, {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
    },
...
exports.createData = async (
  ...
  const res = await fetch(`${process.env.URL}/apis/v1/create-activity`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
exports.updateData = async (
  ...
  const res = await fetch(`${process.env.URL}/apis/v1/update-activity`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
    },
