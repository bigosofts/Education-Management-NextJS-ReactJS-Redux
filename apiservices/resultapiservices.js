...
exports.deleteData = async (id) => {
  const res = await fetch(`${process.env.URL}/apis/v1/delete-result/${id}`, {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
    },
...
exports.createData = async (
  ...
  const res = await fetch(`${process.env.URL}/apis/v1/create-result`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
exports.updateData = async (
  ...
  const res = await fetch(`${process.env.URL}/apis/v1/update-result`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
    },
