...
function updateSliderForm(props) {
    ...
    },[props.payload.sliderTitle.en,props.payload.sliderTitle.bn,props.payload.sliderId,props.payload.sliderButtonTitle.en,props.payload.sliderButtonTitle.bn,props.payload.sliderButtonLink,props.payload.sliderImageLink,props.payload.sliderDescription.en,props.payload.sliderDescription.bn,props.payload.activeStatus,]);
    ...
    const clickHandler =async (e)=>{
        ...
        const res = await updateData(imagelink, sliderid, slidertitle, slidertitlebn, sliderdescription, sliderdescriptionbn, sliderbuttontitle, sliderbuttontitlebn, buttonlink, status, idValue);
    ...
    return (
        <form className='grid lg:grid-cols-3 w-full gap-5'>
            <div className="input-type">
                <input ref={slidertitleref} onChange={onChangeHandler1} value={slider.slidertitle} className="border w-full px-5 py-3 focus:outline-none" type='text' name='slidertitle' placeholder='Enter Slider title'></input>
            </div>
            <div className="input-type">
                <input ref={slidertitlebnref} onChange={onChangeHandler2} className="border w-full px-5 py-3 focus:outline-none" type='text' name='slidertitlebn' placeholder='স্লাইডার টাইটেল লিখুন' value={slider.slidertitlebn}></input>
            </div>
            <div className="input-type">
                <input ref={slideridref} onChange={onChangeHandler3} className="border w-full px-5 py-3 focus:outline-none" type='text' name='sliderid' placeholder='Enter slider id' value={slider.sliderid}></input>
            </div>
            <div className="input-type">
                <input ref={sliderbuttontitleref} onChange={onChangeHandler4} className="border w-full px-5 py-3 focus:outline-none" type='text' name='buttontitle' placeholder='Enter button title' value={slider.sliderbuttontitle}></input>
            </div>
            <div className="input-type">
                <input ref={sliderbuttontitlebnref} onChange={onChangeHandler5} className="border w-full px-5 py-3 focus:outline-none" type='text' name='buttontitlebn' placeholder='বাংলায় বাটন টাইটেল' value={slider.sliderbuttontitlebn}></input>
            </div>
            <div className="input-type">
                <input ref={buttonlinkref} onChange={onChangeHandler6} className="border w-full px-5 py-3 focus:outline-none" type='text' name='buttonlink' placeholder='Enter Button Link' value={slider.buttonlink}></input>
            </div>
            <div className="input-type">
                <input ref={imagelinkref} onChange={onChangeHandler7} className="border w-full px-5 py-3 focus:outline-none" type='text' name='imagelink' placeholder='Enter image link' value={slider.imagelink}></input>
            </div>

            <div className="input-type">
            <textarea ref={sliderdescriptionref} onChange={onChangeHandler8} id="sliderdescription" name="sliderdescription" rows="1" className="border w-full px-5 py-3 focus:outline-none" placeholder='Enter slider Description' value={slider.sliderdescription}></textarea>
            </div>
            <div className="input-type">
            <textarea ref={sliderdescriptionbnref} onChange={onChangeHandler9} id="sliderdescriptionbn" name="sliderdescriptionbn" rows="1" className="border w-full px-5 py-3 focus:outline-none" placeholder='স্লাইডারের বর্ননা লিখুন ' value={slider.sliderdescriptionbn}></textarea>
            </div>
