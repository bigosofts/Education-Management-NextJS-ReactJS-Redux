  ...
  const newArray = [
    {
      ...
      href: `/content/dashboard/${data.data.userName}/class-room/group?code=prealemalema`,
...

    {
      ...
      href: `/content/dashboard/${data.data.userName}/class-room/recorded-classes?code=prealemalema`,
...
export default PreAlemalemaMain;
