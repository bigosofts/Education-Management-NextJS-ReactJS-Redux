    ...
    return (
        <div className='container mx-auto mt-10'>
            ...
            {props.fromupdateform.data.map((item,i) => (
                 ...
                 <a href="#">
                     <img className="rounded-t-lg w-full h-64" src={item.aboutImageLink} alt="" />
                 </a>
                 ...
                 <div className='absolute top-2 left-2'>
                             ...
                             Created at: {new Date(item.aboutCreatedDate).toLocaleDateString()}
                             </div>
                             ...
                             <svg aria-hidden="true" className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd"></path></svg>
                             Updated at: {new Date(item.aboutUpdatedDate).toLocaleDateString()}
                             </div>
                 </div>
                 <div className="p-5">
                     <a href="#">
                         <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">{item.aboutTitle.en}</h5>
                     </a>
                     <a href="#">
                         <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">{item.aboutTitle.bn}</h5>
                     </a>
 
                     <h5 className="mb-2 text-md font-bold tracking-tight text-gray-900 dark:text-white">Description</h5>
                     <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 block max-h-24 overflow-y-scroll">{item.aboutDescription.en}</p>
                     <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 block max-h-24 overflow-y-scroll">{item.aboutDescription.bn}</p>
