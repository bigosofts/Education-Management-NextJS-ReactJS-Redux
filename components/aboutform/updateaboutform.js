...
function updateAboutForm(props) {
    ...
    },[props.payload.aboutTitle.en,props.payload.aboutTitle.bn,props.payload.aboutImageLink,props.payload.aboutDescription.en,props.payload.aboutDescription.bn]);
    ...
    const clickHandler =async (e)=>{
        ...
        const res = await updateData(aboutimagelink,abouttitle,abouttitlebn,aboutdescription,aboutdescriptionbn,status,idValue);
    ...
    return (
        <form className='grid lg:grid-cols-3 w-full gap-5'>
            ...
            <div className="input-type">
                <input ref={abouttitleref} onChange={onChangeHandler1} className="border w-full px-5 py-3 focus:outline-none" type='text' name='abouttitle' placeholder='Enter about title' value={about.aboutTitle}></input>
            </div>
            <div className="input-type">
                <input ref={abouttitlebnref} onChange={onChangeHandler2} className="border w-full px-5 py-3 focus:outline-none" type='text' name='abouttitlebn' placeholder='টাইটেল লিখুন বাংলায়' value={about.aboutTitlebn}></input>
            </div>

            <div className="input-type">
                <input ref={aboutimagelinkref} onChange={onChangeHandler3} className="border w-full px-5 py-3 focus:outline-none" type='text' name='imagelink' placeholder='Enter image link' value={about.aboutImageLink}></input>
            </div>
         
            <div className="input-type">
            <textarea ref={aboutdescriptionref} onChange={onChangeHandler4} id="aboutdescription" name="aboutdescription" rows="1" className="border w-full px-5 py-3 focus:outline-none" placeholder='Enter about Description' value={about.aboutDescription}></textarea>
            </div>
            <div className="input-type">
            <textarea ref={aboutdescriptionbnref} onChange={onChangeHandler5} id="aboutdescriptionbn" name="aboutdescriptionbn" rows="1" className="border w-full px-5 py-3 focus:outline-none" placeholder='আপনার বর্ণনা লিখুন বাংলায়' value={about.aboutDescriptionbn}></textarea>
            </div>
