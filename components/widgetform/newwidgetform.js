    ...
    return (
        <form className='grid lg:grid-cols-3 w-full gap-5'>
            <div className="input-type">
                <input ref={widgettitleref} className="border w-full px-5 py-3 focus:outline-none" type='text' name='widgettitle' placeholder='Enter widget title'></input>
            </div>
            <div>
                <textarea ref={widgetpayloadref} id="widgetpayload" name="widgetpayload" rows="1" className="border w-full px-5 py-3 focus:outline-none" placeholder='Enter Widget payload object here'></textarea>
            </div>
