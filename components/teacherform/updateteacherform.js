    ...
    return (
        <form className='grid lg:grid-cols-3 w-full gap-5'>
            <div className="input-type">
                <input ref={teacherfirstnameref} onChange={onChangeHandler3} value={teacher.firstName} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teacherfirstname' placeholder='Enter First Name'></input>
            </div>
            <div className="input-type">
                <input ref={teacherlastnameref} onChange={onChangeHandler5} value={teacher.lastName} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teacherlastname' placeholder='Enter Last Name'></input>
            </div>
            <div className="input-type">
                <input ref={teacherfirstnamebnref} onChange={onChangeHandler4} value={teacher.firstNamebn} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teacherfirstnamebn' placeholder='নামের প্রথম অংশ লিখুন'></input>
            </div>
            <div className="input-type">
                <input ref={teacherlastnamebnref} onChange={onChangeHandler6} value={teacher.lastNamebn} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teacherlastnamebn' placeholder='নামের শেষের অংশ লিখুন'></input>
            </div>
            <div className="input-type">
                <input ref={fathernameref} onChange={onChangeHandler9} value={teacher.fatherName} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teacherfathername' placeholder='Enter Fathers Name'></input>
            </div>
            <div className="input-type">
                <input ref={fathernamebnref} onChange={onChangeHandler10} value={teacher.fatherNamebn} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teacherfathernamebn' placeholder='বাবার নাম বাংলায় লিখুন'></input>
            </div>
            <div className="input-type">
                <input ref={teacherUserref} onChange={onChangeHandler1} value={teacher.userName} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teacherid' placeholder='Enter Teacher ID'></input>
            </div>
            <div className="input-type">
                <input ref={teachernidref} onChange={onChangeHandler7} value={teacher.nidNumber} className="border w-full px-5 py-3 focus:outline-none" type='number' name='teacheridcard' placeholder='Enter NID Number'></input>
            </div>
            <div className="input-type">
                <input ref={tacherbirthregref} onChange={onChangeHandler8} value={teacher.birthRegNumber} className="border w-full px-5 py-3 focus:outline-none" type='number' name='teacherbirthcard' placeholder='Enter Birth Registration Number'></input>
            </div>
            <div className="input-type">
                <input ref={tacheremailref} onChange={onChangeHandler11} value={teacher.emailAddress} className="border w-full px-5 py-3 focus:outline-none" type='email' name='teacheremail' placeholder='Enter Email Address'></input>
            </div>
            <div className="input-type">
                <input ref={tacherroleref} onChange={onChangeHandler2} value={teacher.userRole} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teachertole' placeholder='Enter Role'></input>
            </div>
            <div className="input-type">
                <input ref={resetpassref} onChange={onChangeHandler12} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teacherpass' placeholder='Reset Password or keep blank'></input>
            </div>
            <div className="input-type">
                <input ref={teachermobileref} onChange={onChangeHandler13} value={teacher.mobileNumber} className="border w-full px-5 py-3 focus:outline-none" type='number' name='teachermobile' placeholder='Enter Mobile Number'></input>
            </div>
            <div className="input-type">
                <input ref={teachereducationref} onChange={onChangeHandler20} value={teacher.educationalBackground} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teachereducation' placeholder='Enter Teacher Education'></input>
            </div>
            <div className="input-type">
                <input ref={teachercoursecoderef} onChange={onChangeHandler14} value={teacher.teacherCourseCode} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teachercoursecode' placeholder='Enter Teacher Course Code'></input>
            </div>
            <div className="input-type">
                <input ref={teacherjamatcoderef} onChange={onChangeHandler15} value={teacher.teacherJamatCode} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teacherjamatcode' placeholder='Enter teacher jamat Code'></input>
            </div>
            <div className="input-type">
                <input ref={teachergenderref} onChange={onChangeHandler16} value={teacher.gender} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teachergender' placeholder='Enter teacher gender'></input>
            </div>
            <div className="input-type">
                <input ref={teacherbirthdateref} onChange={onChangeHandler17} value={teacher.dateOfBirth} placeholder="Enter Birth Date" className="border w-full px-5 py-3 focus:outline-none" type={inputType} onFocus={handleFocus} onBlur={handleBlur} name="teacherbirthdate" />
            </div>
            <div>
                <textarea ref={teacherpresentaddressref} onChange={onChangeHandler18} value={teacher.fullPresentAddress} id="presentaddress" name="presentaddress" rows="1" className="border w-full px-5 py-3 focus:outline-none" placeholder='Enter present address'></textarea>
            </div>
            <div>
                <textarea ref={teacherparmanentaddressref} onChange={onChangeHandler19} value={teacher.fullPermanentAddress} id="permanentaddress" name="permanentaddress" rows="1" className="border w-full px-5 py-3 focus:outline-none" placeholder='Enter Permanent address'></textarea>
            </div>
            <div className="input-type">
                <input ref={teachercountryref} onChange={onChangeHandler21} value={teacher.countryName} className="border w-full px-5 py-3 focus:outline-none" type='text' name='teachercountry' placeholder='Enter teacher country'></input>
            </div>
