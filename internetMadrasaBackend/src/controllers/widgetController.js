...
exports.createWidget = (req, res) => {
    ...
    widgetModel.create(postBody).then((data)=>{
        res.status(200).json({
...
exports.selectWidgets=(req,res)=>{
    ...
    widgetModel.find(query, projection).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
...
exports.updateWidget=(req,res)=>{
    ...
    widgetModel.updateOne({_id:filter}, {$set:postBody},{upsert:true}).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
...
exports.deleteWidget=(req,res)=>{
    ...
    widgetModel.deleteOne({_id:_id}).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
