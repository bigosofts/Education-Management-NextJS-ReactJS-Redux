...
exports.createActivity = (req, res) => {
    ...
    activityModel.create(postBody).then((data)=>{
        res.status(200).json({
...
exports.selectActivities=(req,res)=>{
    ...
    activityModel.find(query, projection).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
...
exports.updateActivity=(req,res)=>{
    ...
    activityModel.updateOne({_id:filter}, {$set:postBody},{upsert:true}).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
...
exports.deleteActivity=(req,res)=>{
    ...
    activityModel.deleteOne({_id:_id}).then((data)=>{
        res.status(200).json({
            status:"Alhamdulillah",
            data: data
        })
