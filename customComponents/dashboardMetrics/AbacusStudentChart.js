...
const BarChartAbacusStudent = ({ getBarChartData }) => {
  ...
  useEffect(() => {
    ...
    function getData() {
      ...
      const filteredClasses =
        ...
        classes.filter((item) => {
          return (
            item.activeStatus === "active" && item.courseID === "abacus_student"
          );
        });
          ...
          let filteredStudentsMale =
            ...
            students.filter((item) => {
              ...
              let activeCourse = item.studentCourseCode.filter(
                (sem) =>
                  /abacus_student/i.test(sem.code) && sem.status === "active"
              );
              ...
              if (
                ...
                if (
                  activeCourse[activeCourse.length - 1].code == "abacus_student"
                ) {
                  return true;
                }
              }
  ...
  return (
    <>
      <h1 style={{ margin: "50px 0px" }}> Abacus Current Students: </h1>
...
export default BarChartAbacusStudent;
