...
const BarChartShishuMaktabPreserve = ({ getBarChartData }) => {
  ...
  useEffect(() => {
    ...
    const ctx = document.getElementById("barChart16").getContext("2d");
  ...
  return (
    <>
      <h1 style={{ margin: "50px 0px" }}> Shishu Maktab Preserve Students: </h1>
      <div style={{ width: "100%", height: "auto" }}>
        <canvas id="barChart16"></canvas>
      </div>
    </>
  );
...
export default BarChartShishuMaktabPreserve;
