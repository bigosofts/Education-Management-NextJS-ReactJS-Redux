  ...
  useEffect(() => {
    ...
    function getData() {
      ...
      const filteredClasses =
        classes.length > 0 &&
        classes.filter((item) => {
          return item.courseID === "prealemalema";
        });
    ...
    const ctx = document.getElementById("barChart12").getContext("2d");
  ...
  return (
    <>
      <h1 style={{ margin: "50px 0px" }}>
        {" "}
        Pre Alem Alema Preserve Students:{" "}
      </h1>
...
export default BarChartPreAlemAlemaPreserve;
