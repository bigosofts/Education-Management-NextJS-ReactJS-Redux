...
const BarChartNajera = () => {
  ...
  useEffect(() => {
    ...
    function getData() {
      ...
      const filteredClasses =
        ...
        classes.filter((item) => {
          return (
            item.activeStatus === "active" && item.courseID === "farzeayinnajera"
          );
        });
          ...
          let filteredStudentsMale =
            ...
            students.filter((item) => {
              ...
              let activeCourse = item.studentCourseCode.filter(
                (sem) =>
                  /farzeayinnajera/i.test(sem.code) && sem.status === "active"
              );
              ...
              if (
                ...
                if (
                  activeCourse[activeCourse.length - 1].code == "farzeayinnajera"
                ) {
                  return true;
                }
              }
    ...
    const ctx = document.getElementById("barChart9").getContext("2d");
  ...
  return (
    <>
      <h1 style={{ margin: "50px 0px" }}> Pre Hifz/Najera Current Students: </h1>
