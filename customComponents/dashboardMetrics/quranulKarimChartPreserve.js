...
const BarChartQuranulKarimPreserve = ({ getBarChartData }) => {
  ...
  useEffect(() => {
    ...
    const ctx = document.getElementById("barChart30").getContext("2d");
...
export default BarChartQuranulKarimPreserve;
