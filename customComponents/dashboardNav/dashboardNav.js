                ...
                <div className="section__content">
                    <div className="container-fluid-custom">
                        <div className="header-wrap">
                            <div onClick={clickHandlerHome} style={{cursor: "pointer"}} className='sidebar__top'>
                                <img src="/logo.png" className="sidebar__logo" alt='logo'></img>
                                <p className='sidebar__logo-name md-block allColorFont'>
                                    Internet Madrasha
                                </p>
                                <form className="form-header" action="" method="POST">
                                <input className="au-input au-input--xl" type="text" name="search" placeholder="Search for datas &amp; reports..."></input>
                            ...
                            <div className="header-button">
                                <div className="noti-wrap">
                                    <div onClick={handleToggle1} className={`noti__item js-item-menu ${show1 ? "show-dropdown": ""}`}>
                                    ...
                                    <div onClick={handleToggle2} className={`noti__item js-item-menu ${show2 ? "show-dropdown": ""}`}>
                                    ...
                                    <div onClick={handleToggle3} className={`noti__item js-item-menu ${show3 ? "show-dropdown": ""}`}>
                                ...
                                <div className="account-wrap">
                                    <div onClick={handleToggle} className={`account-item clearfix js-item-menu ${show ? "show-dropdown" : ""}`}>
                                        <div className="image">
                                            <img src="/logo.png" alt="John Doe"></img>
                                        </div>
                                        <div className="content">
                                            <a className="js-acc-btn allColorFont">{data.data.userName}</a>
                                        </div>
                                        <div className="account-dropdown js-dropdown">
                                            <div className="js-dropdown-one info clearfix">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <span className="email">
                                                        {
                                                            data.data.isAdmin ? "Admin" : data.data.userRole == "student" ? "Student" : "Teacher"
                                                        } Dashboard
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div onClick={handleLogoutClick} className="js-dropdown-three account-dropdown__footer">
                                                <a>
