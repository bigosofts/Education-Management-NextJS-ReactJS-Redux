...
function NoteCard() {
  ...
  return (
    <div style={{width: "450px",backgroundColor:"rgb(243 242 205)", padding:"20px 20px", margin:"auto", borderRadius:"5px", boxShadow:"0px 0px 8px rgba(0, 0, 0, 0.6)"}} classname="noteCard">
