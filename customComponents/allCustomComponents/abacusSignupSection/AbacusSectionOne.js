      ...
      <div class="abacusSecOne">
        ...
        <div class="style-6">
          <div class="style-7">
            ...
            <a href={`${data.widgetPayload[0].card[1].link}`} class="style-26">
              <div class="style-27">
                <div class="style-28">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <a href={`${data.widgetPayload[0].card[2].link}`} class="style-39">
              <div class="style-40">
                <div class="style-41">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <a href={`${data.widgetPayload[0].card[3].link}`} class="style-51">
              <div class="style-52">
                <div class="style-53">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
