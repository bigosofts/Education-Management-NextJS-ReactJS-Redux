  ...
  return (
    <div class="abacusSecOne">
      <div class="style-1">
        <div class="style-2">
          <div class="style-3">
            <h2 class="style-4">গণিত শেখার সহজ ও উপযোগী মাধ্যম</h2>
          </div>
          <div class="style-5">
            দ্রুত গাণিতিক সমাধান করতে চাইলে অ্যাবাকাস হতে পারে তোমার পছন্দের
          </div>
        </div>
      </div>
      <div class="style-6">
        <div class="style-7">
          <a href="/academic/" class="style-8">
            <div class="style-9">
              <div class="style-10">
                <svg
              ...
              <div class="style-21">
                <h2 class="style-22">ক্লাস ৫-১২</h2>
                <p class="style-23">ফ্রি ভিডিও, লাইভ ক্লাস</p>
              </div>
              <svg
                stroke="currentColor"
                fill="none"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <polyline points="9 18 15 12 9 6" class="style-25"></polyline>
              </svg>
            </div>
          </a>
          <a href="/skills/" class="style-26">
            <div class="style-27">
              <div class="style-28">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="style-34">
                <h2 class="style-35">স্কিলস</h2>
                <p class="style-36">ইংলিশ, ফ্রিল্যান্সিং, স্কিলস ও আইটি</p>
              </div>
              <svg
                stroke="currentColor"
                fill="none"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <polyline points="9 18 15 12 9 6" class="style-38"></polyline>
              </svg>
            </div>
          </a>
          <a href="/admission/" class="style-39">
            <div class="style-40">
              <div class="style-41">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="style-46">
                <h2 class="style-47">ভর্তি পরীক্ষা</h2>
                <p class="style-48">বিশ্ববিদ্যালয়+গুচ্ছ, মেডিক্যাল</p>
              </div>
              <svg
                stroke="currentColor"
                fill="none"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <polyline points="9 18 15 12 9 6" class="style-50"></polyline>
              </svg>
            </div>
          </a>
          <a href="/jobs-prep/" class="style-51">
            <div class="style-52">
              <div class="style-53">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="style-63">
                <h2 class="style-64">চাকরি প্রস্তুতি</h2>
                <p class="style-65">বিসিএস, ব্যাংক জবস, সরকারি চাকরি</p>
              </div>
              <svg
                stroke="currentColor"
                fill="none"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <polyline points="9 18 15 12 9 6" class="style-67"></polyline>
              </svg>
            </div>
          </a>
        </div>
