  ...
  return (
    <div className="page-wrapper">
      <div className="page-content--bge5">
        ...
        {abacusID ? <div style={{marginTop:"50px", width: "50%", margin:"auto"}}>
            <h1 style={{fontSize:"24px", textAlign:"center", fontWeight:"900"}}>This is you Abacus ID: <span style={{color:"red"}}>{abacusID}</span> 
            <br/>
